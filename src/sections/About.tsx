...
const expertise = [
  ...
  { icon: Database, title: 'Data Engineering', description: 'ETL, preprocessing, feature engineering' },
      ...
      <div className="relative z-10 w-full px-6 sm:px-8 lg:px-12 xl:px-16">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center max-w-7xl mx-auto">
          ...
          <div style={{ transform: `translateY(${parallaxY}px)` }}>
            ...
            {/* Heading */}
            <h2 
              className={`text-4xl sm:text-5xl lg:text-6xl font-light text-white mb-8 leading-tight transition-all duration-1000 delay-100 ${
            ...
            {/* Description */}
            <div 
              className={`space-y-4 text-white/50 text-lg leading-relaxed mb-12 font-light transition-all duration-1000 delay-200 ${
                isInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6'
              }`}
            >
              <p>
            ...
            <div 
              className={`grid grid-cols-4 gap-6 mb-12 transition-all duration-1000 delay-300 ${
                isInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6'
              }`}
            >
